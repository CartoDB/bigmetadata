...
class DemographicColumns(ColumnsTask):
    ...
    def columns(self):
        ...
        unit_education = input_['unittags']['education']

        mexico = input_['sections']['mexico']
        ...
        households = OBSColumn(
            ...
            weight=3,
            aggregate='sum',
            tags=[mexico, unit_household, subsections['family'], ],
            targets={},
        )
  ...
  ('female_speak_ind_language_no_spanish_age_5_more', female_speak_ind_language_no_spanish_age_5_more),
  ('male_speak_ind_language_no_spanish_age_5_more', male_speak_ind_language_no_spanish_age_5_more),
  ('speak_ind_language_and_spanish_age_5_more', speak_ind_language_and_spanish_age_5_more),
  ('female_speak_ind_language_and_spanish_age_5_more', female_speak_ind_language_and_spanish_age_5_more),
  ('male_speak_ind_language_and_spanish_age_5_more', male_speak_ind_language_and_spanish_age_5_more),
  ...
  ('female_employed_incomplete_secondary_education', female_employed_incomplete_secondary_education),
  ('male_employed_incomplete_secondary_education', male_employed_incomplete_secondary_education),
  ...
  ('female_econ_inactive_phys_mental_limitation', female_econ_inactive_phys_mental_limitation),
  ('male_econ_inactive_phys_mental_limitation', male_econ_inactive_phys_mental_limitation),
