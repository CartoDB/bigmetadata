...
class DownloadIBGE(DownloadUnzipTask):

    censitario = "AC_20150527"
    URL_base = 'http://servicodados.ibge.gov.br/Download/Download.ashx?u=ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_do_Universo/Agregados_por_Setores_Censitarios/{}.zip'.format(censitario)
    URL = URL_base
