...
TIGER_GEOM_COLUMNS = GeomColumns()


class TigerGeoidColumns(BMD):
    block_group = BMDColumn(
        id='block_group_geoid',
        type='Text',
        name='US Census Block Group Geoids',
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.block_group,
                                  reltype='geom_ref')]
    )
    block = BMDColumn(
        id='block_geoid',
        ...
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.block,
                                  reltype='geom_ref')]
    )
    census_tract = BMDColumn(
        ...
        description="",
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.census_tract,
                                  reltype='geom_ref')]
    )
    congressional_district = BMDColumn(
        ...
        description="",
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.congressional_district,
                                  reltype='geom_ref')]
    )
    county = BMDColumn(
        id='county_geoid',
        ...
        description="",
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.county,
                                  reltype='geom_ref')]
    )
    puma = BMDColumn(
        id='puma_geoid',
        ...
        description="",
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.puma,
                                  reltype='geom_ref')]
    )
    state = BMDColumn(
        id='state_geoid',
        ...
        description="",
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.state,
                                  reltype='geom_ref')]
    )
    zcta5 = BMDColumn(
        id='zcta5_geoid',
        ...
        description="",
        weight=0,
        target_columns=[BMDColumnToColumn(target=TIGER_GEOM_COLUMNS.zcta5,
                                  reltype='geom_ref')]
    )

TIGER_GEOID_COLUMNS = TigerGeoidColumns()
    ...
    def columns(self):
        return [
            ...
            BMDColumnTable(colname='geom',
                           column=getattr(TIGER_GEOM_COLUMNS, self.geography))
        ]
