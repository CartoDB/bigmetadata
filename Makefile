...
travis-diff-catalog:
	...
	./run-travis.sh 'ENVIRONMENT=test luigi --module tasks.base_tasks tasks.base_tasks.RunDiff --compare FETCH_HEAD'
	./run-travis.sh 'ENVIRONMENT=test luigi --module tasks.sphinx tasks.sphinx.Catalog --force'
