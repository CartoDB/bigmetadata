# -*- coding: utf-8 -*-
#
# bigmetadata documentation build configuration file, created by
...
htmlhelp_basename = 'bigmetadatadoc'
...
latex_documents = [
  (master_doc, 'bigmetadata.tex', 'Observatory Catalog',
   'CARTO', 'manual'),
]
...
man_pages = [
    (master_doc, 'observatory', 'Observatory Catalog',
     [author], 1)
]
...
pdf_documents = [
    ('index', 'observatory', 'The Data Observatory', 'CARTO', {
    }),
]
