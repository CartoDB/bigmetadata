...
(:ref:`tasks.tasks.DownloadUnzipTask`) and import a CSV on disk to a temporary
table (:ref:`tasks.tasks.CSV2TempTableTask`).  These classes should be used when
...
.. code:: python
    ...
    from tasks.tasks import DownloadUnzipTask
...
:ref:`tasks.tasks.DownloadUnzipTask` will generate the location for a unique
...
a :ref:`tasks.tasks.TableTask` whose ``columns`` method returns
a :ref:`OrderedDict` with much more than 1000 columns, the task will fail.

In such cases, you'll want to split your :ref:`tasks.tasks.TableTask` into
several pieces, likely pulling columns from the same
:ref:`tasks.tasks.ColumnsTask`.  There is no limit on the number of columns in
a :ref:`tasks.tasks.ColumnsTask`.

Each geometry column should have a unique ``geom_ref`` column with it
*********************************************************************

When setting up a :ref:`tasks.tasks.ColumnsTask` for Geometries, make sure that
...
a :ref:`tasks.tasks.ColumnsTask` class, make sure each column is assigned
...
Provided :ref:`tasks.tasks.TableTask` and :ref:`tasks.tasks.ColumnTask` classes were
...
Have you defined and executed a proper :ref:`tasks.tasks.TableTask`?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. code:: python
    ...
    from tasks.tasks import ColumnsTask, TableTask
